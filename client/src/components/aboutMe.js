...
const AboutMe = () => {
  ...
  const bubbleContent = [
    ...
    },
    {
      title: "Education",
      content:
        "In my pursuit of knowledge, I'm about to graduate with a Bachelor of Applied Information in mid November. My bachelor gives me a wide range of knowledge in the various areas such as .NET MAUI development, MERN Web development, game development through Unity and Unreal using C# and a little C++, and some other experiences. These combine to give me a wide variety of skills to break out into the industry with.",
    },
  ];
